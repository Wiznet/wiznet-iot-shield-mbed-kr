...
|:------------------:|:-------------:|:------------:|:-------------------------------------------------|
| [mbed-os-example-cellular](https://os.mbed.com/users/hkjung/code/mbed-os-example-cellular-BG96/) | :heavy_check_mark: | :heavy_check_mark: | Mbed-OS의 Cellular API 기반의 기본적인 데이터 송/수신 예제,<br>지정된 서버로 TCP or UDP 데이터를 보내고 응답 수신 |
