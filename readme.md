...
|:------------------:|:-------------:|:------------:|:-------------------------------------------------|
| mbed-os-example-cellular | :heavy_multiplication_x: | :heavy_multiplication_x: | Mbed-OS의 Cellular API 기반의 기본적인 데이터 송/수신 예제,<br>지정된 [Echo Server](echo.mbedcloudtesting.com)로 TCP or UDP 데이터를 보내고 응답 수신 |
