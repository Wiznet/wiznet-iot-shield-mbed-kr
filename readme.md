...
| [Pelion IoT Platform 연동](https://os.mbed.com/users/stkim92/code/BG96_K6xF_pelion-example-frdm_Temp/) | :heavy_check_mark: | :heavy_multiplication_x: | IoT 연결, 장치 및 데이터 관리 플랫폼인 Arm Pelion 연동 예제 | 
